...
def lowertooth(img):
    ...
    for contour in contours:
        ...
        #find the uppermost and lowermost pts of them
        contour_points = contour[:, 0, :]
        contour_uppermost_point = tuple(contour_points[contour_points[:, 0].argmin()])
        contour_lowermost_point = tuple(contour_points[contour_points[:, 0].argmax()])
    ...
    cv2.putText(img, text_2, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
